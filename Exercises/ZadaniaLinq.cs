...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie04_PierwszyPrzedmiotAnalityczny()
    {
        ...
        {
            return ["Nie znaleziono przedmiotu w kategorii Analytics."];
        }
    ...
    {
        var uzupelnione = DaneUczelni.Prowadzacy.All(p => !string.IsNullOrEmpty(p.Katedra));

        return [$"Kazdy prowadzacy ma uzupelniona nazwe katedry: {uzupelnione}"];
    }
    ...
    {
        var liczbaAktywnych = DaneUczelni.Zapisy.Count(z => z.CzyAktywny);

        return [$"Liczba aktywnych zapisow: {liczbaAktywnych.ToString()}"];
    }
    ...
    {
        return DaneUczelni.Studenci.Select(s => s.Miasto).Distinct().Order();
    }
    ...
    public IEnumerable<string> Zadanie12_ParyStudentPrzedmiot()
    {
        return DaneUczelni.Studenci
            .Join(
                    ...
                    s => s.Id,
                    z => z.StudentId,
                    (s, z) => new { s.Imie, s.Nazwisko, z.PrzedmiotId }
                 )
            .Join(
                    DaneUczelni.Przedmioty,
                    e => e.PrzedmiotId,
                    p => p.Id,
                    (e, p) => $"{e.Imie} {e.Nazwisko}, {p.Nazwa}"
                 );
    }
    ...
    public IEnumerable<string> Zadanie14_SredniaOcenaNaPrzedmiot()
    {
        return DaneUczelni.Przedmioty
            ...
            .GroupBy(e => e.Nazwa)
            .Select(g => $"{g.Key}, {g.Average(e => e.OcenaKoncowa)}");
    }
    ...
    public IEnumerable<string> Zadanie16_NajwyzszaOcenaKazdegoStudenta()
    {
        return DaneUczelni.Studenci
            ...
            .Select(g => $"{g.Key.Imie} {g.Key.Nazwisko}, {g.Max(e => e.OcenaKoncowa)}");
    }
